...
{
    public class DashboardSettingsWrapper : IIpStackConnectorSettings, INewsApiOrgConnectorSettings, IOpenWeatherMapConnectorSettings, ITimeZoneDbConnectorSettings
    {
