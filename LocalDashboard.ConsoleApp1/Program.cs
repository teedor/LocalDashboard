...
using LocalDashboard.ConsoleApp1.Models;
using Newtonsoft.Json;
using RestSharp;

namespace LocalDashboard.ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            var ipAddress = "62.31.103.154";
        ...
        private static DateTime UnixIntToDateTime(int unixDateInteger)
        {
        ...
        private static bool IsTheSunUp(DateTime localTime, DateTime sunrise, DateTime sunset)
        {
